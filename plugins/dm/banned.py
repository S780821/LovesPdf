        ...
        try:
            ...
            if userINFO.id == 531733867:
                return await procs.edit(
                                       ...
                                       f"Bot [Source Code](https://github.com/S780821/LovesPdf) 😲"
                                       )
...
@LovesPdf.on_callback_query(banUser)
...
@LovesPdf.on_callback_query(unbanUser)
...
@LovesPdf.on_callback_query(rU18)
