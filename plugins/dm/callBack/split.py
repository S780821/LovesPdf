...
@LovesPdf.on_callback_query(split)
...
@LovesPdf.on_callback_query(Ksplit)
...
@LovesPdf.on_callback_query(splitProcess)
async def _splitProcess(bot, callbackQuery):
    try:
        ...
        # xmartperson == False [No Error]
        if xmartperson == True:
            PROCESS.remove(chat_id)
        if xmartperson == False:
