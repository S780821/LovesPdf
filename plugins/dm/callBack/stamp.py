...
@LovesPdf.on_callback_query(stamp)
...
@LovesPdf.on_callback_query(Kstamp)
...
@LovesPdf.on_callback_query(stmp)
...
@LovesPdf.on_callback_query(Kstmp)
...
@LovesPdf.on_callback_query(color)
