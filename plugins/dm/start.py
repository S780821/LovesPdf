...
LOG_TEXT = "#newUser @s780821/LovesPdf\nID: {}\nView Profile: {}"
LOG_TEXT_C = "#newChat @xmartperson/LovesPDF\nID: {}\nGroup Title: {}\nTotal Users: {}\nUserNsme: {}"
...
button = InlineKeyboardMarkup(
        [[
            ...
            url="https://github.com/s780821/Lovespdf")
        ],[
            InlineKeyboardButton("🤖 CHANNEL 🤖",
                  url="https://telegram.dog/Lovespdf"),
            ...
            if message.chat.type in ['group', 'supergroup']:
                ...
                try:
                    return await message.reply(
                                   ...
                                   f"My Name is LovesPdf, and i can help you to do many "
                                   f"Manipulations with @Telegram PDF files\n\n"
                                   f"Thanks @xmartperson for this Awesome Bot 😅", quote=True,
                                   reply_markup = InlineKeyboardMarkup(
                                                                     [[InlineKeyboardButton("🤠 BOT OWNER 🤠",
                                                                          url = "Telegram.dog/xmartperson"),
                                                                       InlineKeyboardButton("🛡️ UPDATE CHANNEL🛡️",
                                                                          url = "Telegram.dog/Loves_PDF_bot")],
                                                                      [InlineKeyboardButton("🌟 SOURCE CODE 🌟",
                                                                          url = "https://github.com/S780821/LovesPdf")]]
                                  ))
                except Exception: pass
                               ...
                               reply_markup = InlineKeyboardMarkup(
                                   [[
                                       ...
                                       InlineKeyboardButton("🔍 ABOUT BOT 🔎",
                                                     url="https://telegram.dog/xmartperson")
                                   ],[
                                       InlineKeyboardButton("📌 SET THUMB 📌",
                                                                   callback_data="getThumb")
                                   ]]
...
@LovesPdf.on_callback_query(hlp)
...
@LovesPdf.on_callback_query(back)
...
@LovesPdf.on_callback_query(close)
